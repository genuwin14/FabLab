...
@section('content')
        ...
        <div class="flex-grow-1 d-flex flex-column" style="background-color: #f1f4f8; overflow: hidden;">
            ...
            <main class="flex-grow-1 p-3 p-md-4" style="overflow-y: auto;">
                <div class="container-fluid">
                    ...
                    @include('raw-materials.components.tabs', ['routePrefix' => 'staff'])
                    ...
                    <div class="tab-pane fade {{ $activeTab === 'log' ? 'show active' : '' }}"
                        ...
                        @include('raw-materials.components.usage-log', ['routePrefix' => 'staff'])
                    </div><!-- /#pane-log -->
                    </div><!-- /.tab-content -->
    ...
    @include('raw-materials.components.modal-record-usage', ['routePrefix' => 'staff'])
    @include('raw-materials.components.modal-reverse', ['routePrefix' => 'staff'])
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            ...
            .modal .material-section-title { font-size: 0.62rem; }
