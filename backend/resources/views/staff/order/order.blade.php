                                ...
                                <div class="col-auto d-flex gap-2">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('staff.orders.export', ['format' => 'pdf'] + $exportQuery) }}">
                                                    <i class="bi bi-file-earmark-pdf text-danger"></i>PDF
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('staff.orders.export', ['format' => 'docx'] + $exportQuery) }}">
                                                    <i class="bi bi-file-earmark-word text-primary"></i>Word
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('staff.orders.export', ['format' => 'csv'] + $exportQuery) }}">
