                    ...
                    <div class="row g-3 mb-4">
                        @foreach($statusMeta as $key => $meta)
                            @php
                                ...
                                $cardUrl = $isActive
                                    ? route('staff.purchase.index')
                                    : route('staff.purchase.index', ['status' => $key]);
                            @endphp
                                        ...
                                        @forelse($purchaseOrders as $po)
                                            <tr>
                                                ...
                                                <td class="text-end pe-4">
                                                    <a href="{{ route('staff.purchase.show', $po->purchase_order_id) }}"
    ...
    <div class="modal fade purchase-modal" id="createPOModal" tabindex="-1" aria-labelledby="createPOModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg overflow-hidden">
                ...
                <form action="{{ route('staff.purchase.store') }}" method="POST" id="poForm" class="m-0">
                    @csrf
