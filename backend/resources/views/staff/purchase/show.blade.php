        ...
        <div class="flex-grow-1 d-flex flex-column" style="background-color: #f1f4f8; overflow: hidden;">
            ...
            <main class="flex-grow-1 p-4" style="overflow-y: auto;">
                <div class="container-fluid" style="max-width: 1100px;">
                    ...
                    <!-- Back Button -->
                    <div class="mb-4">
                        <a href="{{ route('staff.purchase.index') }}" class="btn btn-light rounded-pill px-3 shadow-sm border small fw-bold text-muted hover-accent">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            <!-- Status Actions -->
                            <form action="{{ route('staff.purchase.updateStatus', $purchaseOrder->purchase_order_id) }}" method="POST" id="statusForm">
                                @csrf
                                @method('PUT')
