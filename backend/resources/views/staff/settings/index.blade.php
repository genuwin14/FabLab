            ...
            <main class="flex-grow-1 p-4" style="overflow-y: auto;">
                <div class="container-fluid" style="max-width: 880px;">
                    <div class="mb-4">
                        ...
                        <p class="text-muted small mb-0">Manage how your staff account behaves across FABLAB.</p>
                    </div>
                            ...
                            <div class="card-body px-4 pb-4">
                                <div class="setting-row d-flex justify-content-between align-items-center gap-3 py-3 border-top">
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="text-muted">Receive order, inventory, and procurement alerts in the navbar bell and notifications page.</small>
                                    </div>
                                    <div class="form-check form-switch m-0">
                                        ...
                                        <input class="form-check-input settings-switch" type="checkbox" role="switch"
                                            id="staffNotificationsEnabled" name="notifications_enabled" value="1"
                                            {{ $user->notifications_enabled ? 'checked' : '' }}>
                                        <label class="form-check-label visually-hidden" for="staffNotificationsEnabled">Enable notifications</label>
                                    </div>
                                </div>
                            </div>
                        </div>
