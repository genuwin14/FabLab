...
@section('content')
                            ...
                            <form id="supplierFilterForm" method="GET" action="{{ route('admin.suppliers.index') }}"
                                ...
                                <div class="col-auto d-flex gap-2">
                                    ...
                                    <button type="button"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#addSupplierModal" title="Add Supplier">
                                        <i class="bi bi-plus-lg small"></i>
                                        <span class="small fw-bold d-none d-lg-inline">Add Supplier</span>
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            ...
            .modal .supplier-section-title { font-size: 0.62rem; }
            .supplier-modal .modal-dialog,
            .supplier-delete-modal .modal-dialog {
                margin: 0.5rem;
            }
            .supplier-modal-header,
            .supplier-delete-modal-header {
