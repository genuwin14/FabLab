                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="contact_person"
                                class="form-control rounded-pill bg-light border-0 px-3" placeholder="e.g. John Doe">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address" class="form-control bg-light border-0 rounded-3 px-3 py-2" rows="2"
                        ...
                        <div class="col-12 mt-4 text-end">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-4">Save Supplier</button>
                        </div>
                    </div>
                </form>
            </div>
