    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-body p-4 text-center">
                ...
                <h5 class="fw-bold mb-2">Delete Supplier?</h5>
                <p class="text-muted small mb-4">
                    Are you sure you want to delete <span id="deleteSupplierName" class="fw-bold text-dark"></span>?
                ...
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <form id="deleteSupplierForm" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger rounded-pill px-4">Delete Supplier</button>
                    </form>
                </div>
            </div>
        </div>
