...
@section('content')
                            ...
                            <form id="rawMaterialFilterForm" method="GET" action="{{ route('admin.raw-materials.index') }}"
                                ...
                                <div class="col-auto d-flex gap-2">
                                    ...
                                    <button type="button"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#addRawMaterialModal" title="Add Material">
                                        <i class="bi bi-plus-lg small"></i>
                                        <span class="small fw-bold d-none d-lg-inline">Add Material</span>
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            ...
            .material-delete-modal .modal-dialog {
                margin: 0.5rem;
            }
            .material-modal-header,
            .material-delete-modal-header {
