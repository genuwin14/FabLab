            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <h6 class="page-title fw-bold mb-0 text-white text-truncate">
                    @if(request()->routeIs('customer.shop'))
                        Browse Products
                    @elseif(request()->routeIs('customer.customize.my-designs'))
                        My Personal Designs
                    @elseif(request()->routeIs('customer.customize.index'))
                        Customize Product
                    @elseif(request()->routeIs('customer.orders*'))
                        My Orders
                    @elseif(request()->routeIs('customer.cart*'))
                        Shopping Cart
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="dropdown">
                <button type="button" class="navbar-action-btn position-relative" data-bs-toggle="dropdown"
                    ...
                    <span class="action-badge action-badge-dot bg-warning"></span>
                </button>
                <ul class="dropdown-menu dropdown-menu-end notification-dropdown shadow-lg border-0 mt-2">
                    ...
                    <li><a href="{{ route('customer.orders.index') }}" class="dropdown-footer-link">View order activity</a></li>
                </ul>
            </div>
            ...
            <div class="dropdown ms-1">
                <button type="button"
                    ...
                    <div class="d-none d-md-block ms-2 me-2 text-start">
                        ...
                        <div class="text-white-50" style="font-size: 0.65rem; line-height: 1;">Customer</div>
                    </div>
