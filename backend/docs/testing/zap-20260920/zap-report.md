...
| Low | Exceeded High | http://127.0.0.1:8080 | Percentage of slow responses | 97 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of responses with status code 2xx | 61 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of responses with status code 3xx | 33 % |
| Info | Exceeded Low | http://127.0.0.1:8080 | Percentage of responses with status code 4xx | 5 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type application/pdf | 8 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type image/png | 2 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type text/html | 75 % |
...
| Info | Informational | http://127.0.0.1:8080 | Count of total endpoints | 95    |
...
| Session Management Response Identified | Informational | 39 |
...
* URL: http://127.0.0.1:8080/%255C%255C%3F./gsu;n.lastIndex=t;let
  * Node Name: `http://127.0.0.1:8080/\\ (./gsu;n.lastIndex)`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `Apache/2.4.58`
  * Other Info: `There is a chance that the highlight in the finding is on a value in the headers, versus the actual matched string in the response body.`
* URL: http://127.0.0.1:8080/%255Cs+/g,
  * Node Name: `http://127.0.0.1:8080/\s /g,`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `Apache/2.4.58`
...
* URL: http://127.0.0.1:8080/customer/customize%3Fproduct_id=6
...
* URL: http://127.0.0.1:8080/customer/shop
  ...
  * Other Info: `The following pattern was used: \bFROM\b and was detected 5 times, the first in likely comment: "<!-- ==================================================================
         ...
         Replaces", see evidence field for the suspicious comment/snippet.`
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Furniture
...
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Furniture
  ...
  * Other Info: `The following pattern was used: \bFROM\b and was detected 5 times, the first in likely comment: "<!-- ==================================================================
         ...
         Replaces", see evidence field for the suspicious comment/snippet.`
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Machinery%2520%2526%2520Equipment&search=ZAP
...
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Finished%2520Goods
  * Node Name: `http://127.0.0.1:8080/customer/shop (category)`
  * Method: `GET`
  * Parameter: `category`
  * Attack: ``
...
http://127.0.0.1:8080/customer/shop?category=Finished%20Goods
...
http://127.0.0.1:8080/customer/shop?category=Machinery%20%26%20Equipment&search=ZAP
