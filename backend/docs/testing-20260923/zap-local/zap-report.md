...
| Low | Exceeded High | http://127.0.0.1:8080 | Percentage of slow responses | 95 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of responses with status code 2xx | 60 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of responses with status code 3xx | 34 % |
| Info | Exceeded Low | http://127.0.0.1:8080 | Percentage of responses with status code 4xx | 5 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type application/pdf | 13 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type image/png | 3 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type text/css | 1 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type text/html | 59 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type text/javascript | 21 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with content type text/plain | 1 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with method GET | 81 % |
| Info | Informational | http://127.0.0.1:8080 | Percentage of endpoints with method POST | 18 % |
| Info | Informational | http://127.0.0.1:8080 | Count of total endpoints | 61    |
...
| Big Redirect Detected (Potential Sensitive Information Leak) | Low | 11 |
...
* URL: http://127.0.0.1:8080/build
  * Node Name: `http://127.0.0.1:8080/build`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
  * Other Info: `Location header URI length: 28 [http://127.0.0.1:8080/build/].
Predicted response size: 328.
Response Body Length: 337.`
* URL: http://127.0.0.1:8080/build/assets
  * Node Name: `http://127.0.0.1:8080/build/assets`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
  * Other Info: `Location header URI length: 35 [http://127.0.0.1:8080/build/assets/].
Predicted response size: 335.
Response Body Length: 344.`
...
* URL: http://127.0.0.1:8080/'%2520+%2520esc(it.url%2520%257C%257C%2520INDEX_URL&29%2520+%2520'
  * Node Name: `http://127.0.0.1:8080/'   esc(it.url || INDEX_URL)   '`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
...
* URL: http://127.0.0.1:8080
  ...
  * Other Info: ``
* URL: http://127.0.0.1:8080/build/assets/app-COV1aA00.css
  * Node Name: `http://127.0.0.1:8080/build/assets/app-COV1aA00.css`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `Apache/2.4.58 (Win64) OpenSSL/3.1.3 PHP/8.2.12`
  * Other Info: ``
* URL: http://127.0.0.1:8080/build/assets/app-Kijzqt9A.js
  * Node Name: `http://127.0.0.1:8080/build/assets/app-Kijzqt9A.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `Apache/2.4.58 (Win64) OpenSSL/3.1.3 PHP/8.2.12`
...
* URL: http://127.0.0.1:8080/customer/cart
  ...
  * Attack: ``
  * Evidence: `from`
  * Other Info: `The following pattern was used: \bFROM\b and was detected 4 times, the first in likely comment: "<!-- Customer Info. The last two lines are filled from the
                     cart's choices when the preview opens. -->", see evidence field for the suspicious comment/snippet.`
...
* URL: http://127.0.0.1:8080/customer/customize
  ...
  * Attack: ``
  * Evidence: `admin`
  * Other Info: `The following pattern was used: \bADMIN\b and was detected 2 times, the first in likely comment: "<!-- ==================================================================
         Notification toasts (admin / staff / customer)
", see evidence field for the suspicious comment/snippet.`
* URL: http://127.0.0.1:8080/customer/customize
  * Node Name: `http://127.0.0.1:8080/customer/customize`
...
* URL: http://127.0.0.1:8080/customer/customize%3Fproduct_id=4
...
* URL: http://127.0.0.1:8080/customer/my-designs
  ...
  * Other Info: `The following pattern was used: \bFROM\b and was detected 4 times, the first in likely comment: "<!-- modal-body-fill: the Three.js canvas sizes itself off this box,
                 so it stays a fixed frame rather than a sc", see evidence field for the suspicious comment/snippet.`
...
* URL: http://127.0.0.1:8080/customer/shop
  ...
  * Other Info: `The following pattern was used: \bFROM\b and was detected 5 times, the first in likely comment: "<!-- ==================================================================
         ...
         Replaces", see evidence field for the suspicious comment/snippet.`
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Electronics
...
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Electronics
  ...
  * Other Info: `The following pattern was used: \bFROM\b and was detected 5 times, the first in likely comment: "<!-- ==================================================================
         ...
         Replaces", see evidence field for the suspicious comment/snippet.`
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Merchandise&search=ZAP
...
* URL: http://127.0.0.1:8080/customer/orders/10/receipt
  ...
  * Other Info: `cookie:laravel-session
cookie:XSRF-TOKEN`
* URL: http://127.0.0.1:8080/customer/orders/11/receipt
  * Node Name: `http://127.0.0.1:8080/customer/orders/11/receipt`
  * Method: `GET`
  * Parameter: `laravel-session`
  * Attack: ``
  * Evidence: `laravel-session`
...
* URL: http://127.0.0.1:8080/customer/orders/5/receipt
  ...
  * Other Info: `cookie:laravel-session
cookie:XSRF-TOKEN`
* URL: http://127.0.0.1:8080/customer/orders/6/receipt
  * Node Name: `http://127.0.0.1:8080/customer/orders/6/receipt`
  * Method: `GET`
  * Parameter: `laravel-session`
  * Attack: ``
  * Evidence: `laravel-session`
...
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Electronics
  ...
  * Other Info: `cookie:laravel-session
cookie:XSRF-TOKEN`
* URL: http://127.0.0.1:8080/customer/shop%3Fcategory=Electronics&search=ZAP
  * Node Name: `http://127.0.0.1:8080/customer/shop (category,search)`
  * Method: `GET`
  * Parameter: `laravel-session`
  * Attack: ``
...
http://127.0.0.1:8080/customer/shop?category=Merchandise&search=ZAP
